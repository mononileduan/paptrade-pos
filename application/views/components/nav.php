...
echo '          </li>';
echo '          <li>';
echo '              <a href="#modelSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Items</a>';
echo '              <ul class="collapse list-unstyled" id="modelSubmenu">';
echo '                  <li>';
echo '                      <a href="' . base_url() . index_page() . '/models/add">Add Item</a>';
echo '                  </li>';
echo '                  <li>';
echo '                      <a href="' . base_url() . index_page() . '/models">View Items</a>';
echo '                  </li>';
echo '              </ul>';
echo '          </li>';
echo '      </ul>';
