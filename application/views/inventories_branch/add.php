...
<div class="row">
    <div class="col-md-12">
		<form action="" method="post" accept-charset="utf-8">
			...
			<div class="form-group">
				<label for='po_ref_no'>Warehouse PO Ref No.</label>
				<input required="required" type="text" name="warehouse_po_ref_no" class="form-control">
				<?php echo form_error('warehouse_po_ref_no', '<p class="help-block">','</p>'); ?>
			</div>
