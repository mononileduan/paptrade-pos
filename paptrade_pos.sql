...
ALTER TABLE WAREHOUSE_INVENTORY_HIST ADD INDEX WAREHOUSE_INVENTORY_HIST_idx (INVENTORY_ID);
...
ALTER TABLE BRANCH_INVENTORY ADD INDEX BRANCH_INVENTORY_idx (BRANCH_ID);
...
ALTER TABLE BRANCH_INVENTORY_HIST ADD INDEX BRANCH_INVENTORY_HIST_idx (INVENTORY_ID);
...
ALTER TABLE SUPPLY_REQUESTS ADD INDEX SUPPLY_REQUESTS_idx (BRANCH_ID);
...
ALTER TABLE SALES ADD INDEX SALES_idx (BRANCH_ID);
...
ALTER TABLE SALES_DTLS ADD INDEX SALES_DTLS_idx (SALES_ID);
...
ALTER TABLE SALES_TEMP ADD INDEX SALES_TEMP_idx (BRANCH_ID);
...
ALTER TABLE SALES_TEMP_DTLS ADD INDEX SALES_TEMP_DTLS_idx (SALES_TEMP_ID);




INSERT INTO `BRANCHES` (`ID`, `VERSION`, `DEL`, `BRANCH_NAME`, `ADDRESS`, `CONTACT`, `CREATED_BY`, `CREATED_DT`, `UPDATED_BY`, `UPDATED_DT`) VALUES ('init_branch',0,false,'INITIAL BRANCH','INITIAL BRANCH ADDRESS', 'INITIAL BRANCH CONTACT','INITIAL_USER','2020-03-29',null,null);
